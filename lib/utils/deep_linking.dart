...
class DeepLinkingUtils {
  void branchListenLinks() {
    // Temporarily commented out Branch SDK functionality
    /*
    ...
    */
    log('Deep linking functionality temporarily disabled');
  }
  ...
  void generateLink(BuildContext context) async {
    ...
    */
    ...
    // Using a mock URL for demo purposes
    const mockUrl = "https://example.com/share/hotlines";
    
    if (context.mounted) {
      shareLink(mockUrl, context);
    }
  }
